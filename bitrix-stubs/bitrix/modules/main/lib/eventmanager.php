...
class EventManager
{
     ...
     * @return int
     */
    public function addEventHandler(string $fromModuleId, string $eventType, $callback, $includeFile = false, int $sort = 100): int
    {
        return 0;
    }
     ...
     * @return int
     */
    public function addEventHandlerCompatible(string $fromModuleId, string $eventType, $callback, $includeFile = false, int $sort = 100): int
    {
        return 0;
    }
